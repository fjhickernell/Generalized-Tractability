...
For any $d\in\naturals$, let
\begin{align*}
L_{\vp'} & := \left[C_{\vp'} + \frac{2}{T(0,1,\vp')}   \right]
\intertext{and note that }
 \min(i(\infty,d,\vp'),2) & \le i(\infty,d,\vp') +1  = \lfloor C_{\vp'}\, T(0,d,\vp')\rfloor +2 \le  \left[C_{\vp'} + \frac{2}{T(0,d,\vp')}   \right]\, T(0,d,\vp')\\
 & \le  L_{\vp'}\, T(0,d,\vp')
 \le \lceil L_{\vp'} T(0,d,\vp')\rceil .
\end{align*}
...
\[
\sum_{i = \lceil L_{\vp'} T(0,d,\vp')\rceil }^{M(d)} \frac{1}{T (\lambda_{i,d}^{-1},1, \vp')} = 0,
\]
