...
\end{align*}	
\fred{Maybe this last assumption on $T$ tending to infinity also depends on the additivity or something similar.}  Since $c$ is arbitrary, we have satisfied the condition of Definition \ref{def:subhT}.
