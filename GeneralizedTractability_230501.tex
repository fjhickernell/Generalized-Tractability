...
\kachi{In the following we introduce two specific cases of tractability which depend on the form of the function $T$.
...
\]
%In addition, we assume the following conditions as in (\ref{eq:ptauassume}). That is, there exists a $K_{(p,q),\tau}$ depending on $p,q$ and $\tau$, but independent of $\varepsilon$ and $d$, such that
%\begin{equation} \label{eq:tractiff}    \sup_{d \in \naturals} \frac{1}{\psi(d,q)} \sum_{i = C(p,q)}^\infty \frac{1}{\phi(\lambda_{i, d}^{-1},p))} < \infty.\end{equation}
Furthermore, we assume that
\[
\lim_{\varepsilon\rightarrow0}T(\varepsilon^{-1},d,\vp) = \infty \qquad \forall d\in\naturals, \vp \in[0,\infty)^2.
\]
Also since $T(\cdot,d,\vp)$ is non-decreasing, we may define the following limit
\[
T(0,d,\vp):= \lim_{\varepsilon \rightarrow \infty}T(\varepsilon^{-1},d,\vp)\geq T(0,1,\textbf{0})>0
\] 
%Furthermore, we assume the following technical conditions. There exists a $K_{(p,q),\tau}$ depending on $p,q$ and $\tau$, but independent of $\varepsilon$ and $d$, such that
\begin{align*}
     [\phi(\varepsilon^{-1},p)]^{\tau} &\le K_{(p,1),\tau} \phi (\varepsilon^{-1},\tau p)\\
      [\psi(d,q)]^{\tau} &\le K_{(1,q),\tau} \psi (d,\tau q) \qquad \forall \, \varepsilon \in (0,\infty),\, d\in \naturals,\, p,q\geq 0,\, \tau >0.
\end{align*}
%\begin{align*}
 %  [T(\varepsilon^{-1},d,\vp]^\tau \leq K_{\vp,\tau}T(\varepsilon^{-1},d,\tau\vp) \quad \forall \varepsilon \in (0,\infty),\, d\in \mathbb{N},\, \vp\in[0,\infty)^2, \tau >0\end{align*}
...
\[
 \sup_{d \in \naturals} \frac{1}{\psi(d,q)} \sum_{i = L_{(p,q)\psi(d,q)}}^\infty \frac{1}{\phi(\lambda_{i, d}^{-1},p)} < \infty.
\]
...
\[
 ...
 \qquad \forall \varepsilon > 0, \,  d \in \naturals, \, \vp\in [0,\infty).
\]  with non-decreasing functions $\phi : (0,\infty) \to (0,\infty)$ and $\psi : \naturals \to (0,\infty)$ and $\vp = p$. Furthermore, we assume the following technical conditions. There exists a $K_{(p,q),\tau}$ depending on $p,q$ and $\tau$, but independent of $\varepsilon$ and $d$, such that
\begin{align*}
     [\phi(\varepsilon^{-1},p)]^{\tau} &\le K_{(p,1),\tau} \phi (\varepsilon^{-1},\tau p)\\
      [\psi(d,q)]^{\tau} &\le K_{(1,q),\tau} \psi (d,\tau q) \qquad \forall \, \varepsilon \in (0,\infty),\, d\in \naturals,\, p,q\geq 0,\, \tau >0.
\end{align*}
...
Suppose that the domain of interesting $(\varepsilon^{-1},d)$ is not all of $(0,\infty \times \naturals$ but given by 
\begin{equation}
    \Omega  = \{(\varepsilon^{-1},d) : \varepsilon > E(d) \ge 0, \ d \in \naturals \},
\end{equation}
where $E$ is a non-increasing function.  A problem is
...
Since the $\lambda_{i,d}$ are non-increasing in $i$, it follows that the $T(\lambda_{i,d}^{-1},d,\vp)$ are non-decreasing in $i$ for $i \in \{1, \ldots, M(d)+1\}$. In particular, for  any $n \in \{N, \ldots, M(d)\}$
\begin{align*}
    \lambda_{n+1,d} \le \lambda_{n,d} \le \cdots \le \lambda_{N,d}
    & \implies \frac{1}{T(\lambda_{n+1, d}^{-1},d,\vp)} \le \frac{1}{T(\lambda_{n, d}^{-1},d,\vp)} \le \cdots \le \frac{1}{T(\lambda_{N, d}^{-1},d,\vp)} \\
     \implies \frac{1}{T(\lambda_{n+1, d}^{-1},d,\vp) }
...
it follows from \eqref{eq:compUP} with $N = \lceil L_{\vp}\, T(0,d,\vp)\rceil$ that 
\begin{align*}
       \comp(\varepsilon,d)
       & \le T(\varepsilon^{-1},d,\vp) \Biggl [ 
       \frac{\lceil L_{\vp}\, T(0,d,\vp)\rceil}{T(\varepsilon^{-1},d,\vp)}  + 
