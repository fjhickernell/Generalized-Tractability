...
In this section, we present six examples relating to Theorem \ref{thm_main_strong_tract2} and Theorem \ref{thm_main_tract2}, both of which were introduced in Section \ref{sec:spt}, for the various types of tractability that are listed in Table \ref{tab:commonT}. In subsequent sections, we will continue to present various examples.
...
The (strong) polynomial tractability for both the algebraic case and the exponential case will be first considered as follows: 
...
\]
\end{example}
We summarize the tractability notions in the previous examples in the following example. The
