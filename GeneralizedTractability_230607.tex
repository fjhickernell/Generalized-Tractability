...
A tractability function $T$ is a function of a simple form that provides an upper bound on the \peter{information} complexity of a problem.  Some examples of tractability functions commonly considered are provided in Table \ref{tab:commonT}.
\kachi{}
\begin{table} 
